"""Setup configuration for guardianmatrix."""
...
setup(
    ...
    description="Distributed threat monitoring and network traffic analysis across multi-node systems",
    long_description=open("README.md").read(),
    long_description_content_type="text/markdown",
    url="https://github.com/fracois-lavoiz/guardianmatrix",
